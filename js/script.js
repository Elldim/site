...
// Закрытие модального окна регистрации при клике вне него
...
// Открытие модального окна "Авторизация" в окне "Регистрация" при нажатии на кнопку "Вход"
document.getElementById("registration-login-btn").addEventListener('click', function() {
  var modalReg = document.getElementById('modal-window-reg');
  modalReg.classList.remove('open');
  document.body.style.overflow = "";
